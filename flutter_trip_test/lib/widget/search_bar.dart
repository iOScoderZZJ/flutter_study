...
class _SearchBarState extends State<SearchBar> {
      ...
      child: Row(
        children: <Widget>[
          Icon(
            Icons.search,
            size: 20,
            color: widget.searchBarType == SearchBarType.home ? Color(
          ...
          Expanded(
            ...
            child: widget.searchBarType == SearchBarType.normal
              ...
              onChanged: _onChanged,///这传递的是函数的引用所以不用传值
              autofocus: true,
              style: TextStyle(
                fontSize: 18,
                color: Colors.black,
          ...
          _wrapTap(
              Icon(
                Icons.mic,
                size: 22,
                color: widget.searchBarType == SearchBarType.normal ? Colors
                    .blue : Colors.grey,
              ), widget.speakClick)
              : _wrapTap(
              Icon(
  ...
  _homeFontColor(){
    return widget.searchBarType == SearchBarType.homeLight ? Colors.black45 : Colors.white;
  }
